...
const steps = [
  ...
  },
  {
    ...
    handoff:
      'Configure Mapbox, the contracted OSRM-compatible matrix, error monitoring, Postmark, and Cloudflare R2 sandbox/test resources. SMS is intentionally disabled.',
    required: [
      'ROUTING_MATRIX_PROVIDER',
      'ROUTING_MATRIX_BASE_URL',
      'ROUTING_MATRIX_PROVIDER_LABEL',

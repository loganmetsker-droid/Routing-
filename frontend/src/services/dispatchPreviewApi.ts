...
export const previewReroutePreview = async (
  ...
  impactSummary: {
    score: 0.8,
    feasible: true,
    rationale: 'Local preview reroute estimate complete.',
  },
  impliedDataQuality: 'degraded',
  ...
  alternatives: [
    {
      ...
      summary: `Estimated impact for action ${payload.action}`,
      feasible: true,
      score: 0.82,
      rank: 1,
      rationale: 'Estimated locally from seeded route data.',
